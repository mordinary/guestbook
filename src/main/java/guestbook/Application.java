...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!","123@h.com"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby","124@h.com"), //
					new GuestbookEntry("Duke Nukem",
							"It's time to kick ass and chew bubble gum. And I'm all out of gum.","125@h.com"),//
					new GuestbookEntry("Gump1337",
							"Mama always said life was like a box of chocolates. You never know what you're gonna get.","126@h.com"),
					new GuestbookEntry("mordinary","ohyeahhhh","127@h.com")).forEach(guestbook::save);
